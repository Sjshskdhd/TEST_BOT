...
conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ هلا يحب نورت الجروب/𝙰* \n*║*\n*╟❧ متنساش تقرا بايو الجروب*\n\n@desc\n\n*║*\n*╟❧ !!*\n*╚══════════════*'
conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ باي يا حب تروح يجي غيرك* \n*╚══════════════*'
conn.spromote = '*@user تم رفعه ادمن 🕷️✨♥️
conn.sdemote = '*@user لم يعد ادمن🕷️✨♥️!!*'
conn.sDesc = '*تم تحديث بايو*\n\n*الجروب* @desc'
conn.sSubject = '*𝚂𝙴 𝙷𝙰 𝙼𝙾𝙳𝙸𝙵𝙸𝙲𝙰𝙳𝙾 𝙴𝙻 𝙽𝙾𝙼𝙱𝚁𝙴 𝙳𝙴𝙻 𝙶𝚁𝚄𝙿𝙾*\n*𝙽𝚄𝙴𝚅𝙾 𝙽𝙾𝙼𝙱𝚁𝙴:* @subject'
conn.sIcon = '*تم تغير ايقونة المحموعة!!*'
conn.sRevoke = '*تم تغير لينك الجروب:* @revoke'
...
let bio = `🤖 البوت نشط من: ${uptime} ┃ 👑 ʙʏ Draken ┃ 🔗 ᴄᴜᴇɴᴛᴀs ᴏғᴄ: https://https://instagram.com/virus_forever_101`
