...
await conn.sendButton(m.chat, `*「 منع الروابط 」*\n*تم اكتشاف رابط بيب وتم طردك يا حثالة باي 👋, ${await this.getName(m.sender)} 🐼${isBotAdmin ? '' : '\n\n*[❗معلومات❗] البوت مش ادمن يجب رفع البوت ادمن اولا*'}`, author, ['𝙳𝙴𝚂𝙰𝙲𝚃𝙸𝚅𝙰𝚁 𝙰𝙽𝚃𝙸𝙻𝙸𝙽𝙺𝚂', '/disable antilink'], m)    
