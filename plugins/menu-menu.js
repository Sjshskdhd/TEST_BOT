...
║    ◉— *𝘋𝘙𝘈𝘒𝘌𝘕 𝘉𝘖𝘛* —◉
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡║
║➤ *السلام عليكم ورحمة الله وبركاتة, ${taguser}*
║≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡║
║➤ *المطور:* 𝘋𝘙𝘈𝘒𝘌𝘕
...
┣ *👾 الفلوس:* ${money}
┣ *🪙 الرموز:* ${joincount}
┣ *🎟️ عضو ذهبي:* ${user.premiumTime > 0 ? '✅' : (isPrems ? '✅' : '❌') || ''}
┗━━━━━━━━━━━━━━━━┛
${readMore}
┏━━━━━━━━━━━━━━━━┓
┃ *<صدقني انا لو اعرف هقولك/>*
┃≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡┃
...
┏━━━━━━━━━━━━━━━━┓
┃ *< اوامر الانضمام اللي المجموعات من الرابط />*
┃≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡┃
...
┏━━━━━━━━━━━━━━━━┓
┣ *< ارسال تقرير بي الاخطا لي المالك />*
┃≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡┃
...
┃ *< مغير الصوت />*   
┃≡≡≡≡𝙴𝚂𝙲𝚁𝙸≡≡≡≡≡≡≡≡≡≡≡≡┃
┃ *- اكتب الاوامر التالية بدون (#, /, *, .)* 
┃ _- (استخدم بدون نقطه)_
┃≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡≡┃
...
`.trim()
let buttons = [
{ buttonId: '#donar', buttonText: { displayText: '📮 الانصتا 📮' }, type: 1 },
//{ buttonId: '#terminosycondiciones', buttonText: { displayText: '📋 𝚃𝙴𝚁𝙼𝙸𝙽𝙾𝚂 𝚈 𝙲𝙾𝙽𝙳𝙸𝙲𝙸𝙾𝙽𝙴𝚂 📋' }, type: 1 }]
{ buttonId: '#infobot', buttonText: { displayText: '🐾 معلومات البوت🐾' }, type: 1 }]
let buttonMessage = {
image: pp,
caption: str.trim(),
mentions: [m.sender],
...
body: null,
thumbnail: img,
sourceUrl: `https://www.instagram.com/virus_forever_101`
}}}
conn.sendMessage(m.chat, buttonMessage, { quoted: m })
//await conn.sendFile(m.chat, vn, 'menu.mp3', null, m, true, { type: 'audioMessage', ptt: true})
} catch {
conn.reply(m.chat, '*[❗المعلومات❗] يوجد خطا تم ابلاغ المالك*', m)
}}
handler.command = /^(menu|اوامر البوت|اوامر|الاوامر|مينو|info|comandos|allmenu|2help|menu1.2|ayuda|commands|commandos|cmd)$/i
handler.exp = 50
handler.fail = null
